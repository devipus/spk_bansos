    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">Form bobot gap</h3>
      ...
      <div class="row">
        <div class="col-md-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <table id="bobotgap-table" class="table table-striped">
                        <thead>
                            <tr>
                                <th>selisih</th>
                                <th>bobot</th>           
...
$(document).ready(function() {
    ...
    table = $('#bobotgap-table').DataTable({
        processing: true,
        serverSide: true,
        bLengthChange: true,
        iDisplayLength: 5,
    ...
    var validator= $('#modal-form form').validator();
        ...
        if (!e.isDefaultPrevented()) {
            var id = $('#id_bobotgap').val();
            if (save_method == 'add') url = "{{ url('bobotgap') }}";
            else url = "{{ url('bobotgap') . '/' }}" + id;
...
function editForm(id) {
    ...
    $.ajax({
        url: "{{ url('bobotgap') }}" + '/' + id + "/edit",
        type: "GET",
        dataType: "JSON",
        success: function(data) {
            console.log(data);
            $('#modal-form').modal('show');
            $('.modal-title').text('Edit bobotgap');
         
            $('#id_bobotgap').val(data.id_bobotgap);
